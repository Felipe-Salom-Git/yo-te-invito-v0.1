...
export const auditActionSchema = z.enum([
  ...
  'GASTRO_DISCOUNT_TEMPLATE_CREATED',
  'GASTRO_DISCOUNT_TEMPLATE_UPDATED',
  'GASTRO_DISCOUNT_TEMPLATE_RESET',
  'ACTIVITY_COUPON_CREATED',
  'ACTIVITY_COUPON_UPDATED',
  'ACTIVITY_COUPON_APPROVED',
  'ACTIVITY_COUPON_REJECTED',
  'ACTIVITY_COUPON_CANCELLED',
  'ACTIVITY_COUPON_ARCHIVED',
  'ACTIVITY_COUPON_UNARCHIVED',
  'ACTIVITY_COUPON_REDEEMED',
  'ACTIVITY_COUPON_CLAIMED',
  ...
  'BENEFIT_CREDIT_DEBITED_FOR_COURTESY',
]);
