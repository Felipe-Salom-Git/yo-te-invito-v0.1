...
export const notificationKindSchema = z.enum([
  ...
  'GASTRO_DISCOUNT_PENDING_REVIEW',
  'GASTRO_DISCOUNT_APPROVED_BY_ADMIN',
  'GASTRO_DISCOUNT_REJECTED_BY_ADMIN',
  'GASTRO_DISCOUNT_EXPIRED',
  'GASTRO_PROFILE_APPROVED_BY_ADMIN',
...
/** V3.3 Etapa 5 — lifecycle Gastro (descuento + perfil). */
export const GASTRO_LIFECYCLE_NOTIFICATION_KINDS = [
  'GASTRO_DISCOUNT_PENDING_REVIEW',
  'GASTRO_DISCOUNT_APPROVED_BY_ADMIN',
  'GASTRO_DISCOUNT_REJECTED_BY_ADMIN',
  'GASTRO_DISCOUNT_EXPIRED',
...
export type GastroLifecycleNotificationKind =
  (typeof GASTRO_LIFECYCLE_NOTIFICATION_KINDS)[number];
