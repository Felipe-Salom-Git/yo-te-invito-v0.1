...
const ACTION_LABELS: Record<string, string> = {
  ...
  ACTIVITY_COUPON_UNARCHIVED: 'Cupón de Actividades restaurado del archivo',
  ACTIVITY_COUPON_REDEEMED: 'Cupón de Actividades validado en Scanner',
  ACTIVITY_COUPON_CLAIMED: 'Cupón de Actividades reclamado',
  GASTRO_DISCOUNT_EDIT_SUBMITTED: 'Edición de descuento gastro enviada a revisión',
  GASTRO_DISCOUNT_EDIT_APPROVED: 'Edición de descuento gastro aprobada',
  GASTRO_DISCOUNT_EDIT_REJECTED: 'Edición de descuento gastro rechazada',
  GASTRO_DISCOUNT_ARCHIVED: 'Descuento gastro archivado',
  GASTRO_DISCOUNT_UNARCHIVED: 'Descuento gastro restaurado del archivo',
  ADMIN_GASTRO_DISCOUNT_CREATED: 'Descuento gastro creado por administración',
  GASTRO_PROFILE_APPROVED: 'Local gastro aprobado',
  GASTRO_PROFILE_REJECTED: 'Local gastro rechazado',
