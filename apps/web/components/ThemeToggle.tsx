...
export function ThemeToggle() {
  ...
  return (
    <button
      type="button"
      onClick={toggle}
      className="inline-flex min-h-9 min-w-9 items-center justify-center rounded border border-border bg-bg-muted p-2 text-text-muted transition-colors hover:text-text focus:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-bg"
