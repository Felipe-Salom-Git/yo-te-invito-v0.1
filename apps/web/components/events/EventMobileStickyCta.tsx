  ...
  return (
    ...
    >
      ...
      <Link
        ...
        className="flex-shrink-0 rounded-lg bg-accent px-5 py-2.5 font-semibold text-bg shadow-lg shadow-accent/25 transition-all hover:bg-accent-hover focus:outline-none focus:ring-2 focus:ring-accent focus:ring-offset-2 focus:ring-offset-bg"
      >
        {ctaLabel}
      </Link>
    </div>
