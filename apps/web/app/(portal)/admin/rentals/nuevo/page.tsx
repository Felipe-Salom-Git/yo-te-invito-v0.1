...
export default function AdminRentalNuevoPage() {
  ...
  return (
    <PageContainer>
      ...
      <SectionTitle>Crear rental (alquiler)</SectionTitle>
      ...
      <form onSubmit={handleSubmit} className="mt-6 max-w-xl space-y-4">
        ...
        <Input label="Capacidad (opcional)" type="number" value={capacityTotal} onChange={(e) => setCapacityTotal(e.target.value)} placeholder="Ej. 8" />
