    ...
    return (
        <PageContainer>
            ...
            {isLoading ? (
                ...
                <p className="text-red-400">Error al cargar los productores</p>
            ) : producers.length === 0 ? (
                <p className="text-text-muted">No hay productores disponibles por el momento.</p>
            ) : (
                    ...
                    {producers.map((producer) => (
                        ...
                        >
                            <div className="mb-4 flex h-20 w-20 items-center justify-center overflow-hidden rounded-full bg-accent text-bg font-bold">
                                {producer.logoUrl ? (
                                    <img src={producer.logoUrl} alt={producer.displayName} className="h-full w-full object-cover" />
                                ) : (
