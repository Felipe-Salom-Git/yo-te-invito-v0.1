...
export default function HotelApplicationSuccessPage() {
  return (
      ...
      <Card className="w-full max-w-md">
        <CardHeader>
          ...
          <p className="text-sm text-text-muted">
            Tu solicitud para cuenta hotel fue enviada. Te avisaremos cuando sea aprobada. Luego podrás completar los
            datos del establecimiento desde tu cuenta.
          </p>
        </CardHeader>
        <CardContent>
          <Link href="/home">
