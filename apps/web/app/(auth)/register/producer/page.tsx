  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      const res = await fetch(url, {
        ...
        body: JSON.stringify({ ...body, role: 'PRODUCER_OWNER', tenantId: 'tenant-demo' }),
      });
      ...
      router.push('/register/producer/success');
      router.refresh();
    } catch (err) {
  ...
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center gap-8 p-8">
      ...
      <Card className="w-full max-w-md">
        <CardHeader>
          <h1 className="text-xl font-semibold text-text">Solicitar cuenta productora</h1>
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Input label="Razón social / Nombre del negocio" name="businessName" placeholder="Mi Productora SRL" error={fieldErrors.businessName} />
