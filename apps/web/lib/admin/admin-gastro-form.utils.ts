...
export function mapAdminGastroDetailToGastroLocal(
  ...
  return {
    ...
    openingHoursMode: detail.openingHoursMode ?? 'simple',
    openingHoursWeekly: detail.openingHoursWeekly ?? null,
    contactPhone: detail.contactPhone,
    contactEmail: detail.contactEmail,
    menuUrl: detail.menuUrl,
    websiteUrl: detail.websiteUrl,
    bookingUrl: detail.bookingUrl ?? null,
    socialLinks: detail.socialLinks ?? null,
...
export function gastroPayloadToAdminCreate(
  ...
  return {
    ...
    openingHoursMode: payload.openingHoursMode,
    openingHoursWeekly: payload.openingHoursWeekly,
