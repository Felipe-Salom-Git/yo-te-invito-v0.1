...
export const adminBenefitAgreementsKeys = {
  all: ['admin', 'benefit-agreements'] as const,
  list: (filtersKey: string) => [...adminBenefitAgreementsKeys.all, 'list', filtersKey] as const,
  detail: (id: string) => [...adminBenefitAgreementsKeys.all, 'detail', id] as const,
  partnerHistory: (filtersKey: string) =>
...
export const adminBenefitSettlementsKeys = {
  ...
  audit: (id: string) => [...adminBenefitSettlementsKeys.all, 'audit', id] as const,
};

export const adminBenefitReportingKeys = {
  all: ['admin', 'benefit-reporting'] as const,
  monthly: (filtersKey: string) => [...adminBenefitReportingKeys.all, 'monthly', filtersKey] as const,
  partners: (filtersKey: string) =>
    [...adminBenefitReportingKeys.all, 'partners', filtersKey] as const,
  integrity: (filtersKey: string) =>
    [...adminBenefitReportingKeys.all, 'integrity', filtersKey] as const,
};
...
export const gastroKeys = {
  ...
  discountVisualTemplate: (id: string) =>
    [...gastroKeys.all, 'discount-visual-template', id] as const,
...
export const adminGastroKeys = {
  ...
  discountVisualTemplate: (profileId: string, discountId: string) =>
    [...adminGastroKeys.all, 'discount-visual-template', profileId, discountId] as const,
};
